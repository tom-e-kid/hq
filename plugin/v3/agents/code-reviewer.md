...
description: >
  ...
  assistant: "Launching code-reviewer as part of /hq:loop Stage 3 reviewer selection (J4)."
  <commentary>
...
These are the quality signals that used to come from `/simplify`. With `/simplify` retired from the review stage, they now live in this agent's scope.
