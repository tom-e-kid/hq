...
The executor emits `build_result` and the retro-distiller emits `retro` themselves (their protocols specify it). The kind catalog is **closed** — extending it is a deliberate edit to this table, not a runtime improvisation.
